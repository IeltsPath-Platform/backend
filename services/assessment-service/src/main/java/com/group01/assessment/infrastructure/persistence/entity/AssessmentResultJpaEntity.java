...
@Entity
@Table(name = "assessment_results", uniqueConstraints = @UniqueConstraint(name = "uk_result_version", columnNames = {"attempt_id", "result_version"}))
...
public class AssessmentResultJpaEntity {
    ...
    @Column(name = "overall_band") private Double overallBand;
