...
public class GameEventJpaEntity {
    ...
    public GameEventJpaEntity(UUID id, UUID matchId, UUID matchPlayerId, long sequenceNo, String eventType, Map<String,Object> payload, Instant at) { this.id=id; this.matchId=matchId; this.matchPlayerId=matchPlayerId; this.sequenceNo=sequenceNo; this.eventType=eventType; this.payload=payload; this.occurredAt=at; this.createdAt=at; }
}
