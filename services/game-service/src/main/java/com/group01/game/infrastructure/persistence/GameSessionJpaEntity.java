...
public class GameSessionJpaEntity {
    ...
    public UUID getMatchPlayerId() { return matchPlayerId; }
    public void complete(Instant at) { status = GameSessionStatus.COMPLETED; endedAt = at; }
    public void abandon(Instant at) { status = GameSessionStatus.ABANDONED; endedAt = at; }
}
